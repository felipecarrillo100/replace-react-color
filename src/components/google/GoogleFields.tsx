...
export const GoogleFields: FC<GoogleFieldsProps> = ({ onChange, rgb, hsl, hex, hsv }) => {
  ...
  return (
    <div style={styles.wrap as React.CSSProperties} className="flexbox-fix">
      <div style={styles.fields as React.CSSProperties}>
        <div style={styles.double as React.CSSProperties}>
          <EditableInput
            style={{ input: styles.input as React.CSSProperties, label: styles.label as React.CSSProperties }}
            label="hex"
            value={hex}
        ...
        <div style={styles.column as React.CSSProperties}>
          <div style={styles.single as React.CSSProperties}>
            <EditableInput
              style={{ input: styles.input2 as React.CSSProperties, label: styles.label2 as React.CSSProperties }}
              label="rgb"
              value={rgbValue}
              onChange={handleChange}
            />
